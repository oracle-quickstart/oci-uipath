<#
    ...
    .PARAMETER orchestratorVersion
      String. Allowed versions: FTS 20.4.5 and LTS 19.10.19 Version of the Orchestrator which will be installed. Example: $orchestratorVersion = "19.10.19"
...
param(
  ...
  [Parameter()]
  [ValidateSet('19.10.19','20.4.5')]
  [string] $orchestratorVersion = "20.4.5",
